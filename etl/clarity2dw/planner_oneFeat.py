...
job_config = {
    ...
    and os.environ['transform'] == 'False' else \
  {
    ...
    'populate_measured_features': {
      'fid': ['systemic_steroids_dose','ampicillin_dose'], #TODO add FID here 
  ...
  'fillin': False if 'fillin' in os.environ \
    and os.environ['fillin'] == 'False' else False,
  # {
  ...
  in os.environ and os.environ['offline_criteria_processing'] == 'False' else False, 
  # {
