...
cdm_defs = {
    ...
    'height': {
        ...
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'height',
    },
    'pain_location': {
        'unit':     '',
        'value':    str,
        'thresh':   (None, None),
        'human_readable':   'Pain Location',
    },
    'oral_intake': {
        'unit':     'mL',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'Oral Intake',
    },
    'fev1': {
        'unit':     'L',
        'value':    float,
    ...
    'sleep_apnea': {
        ...
        'value':    str,
        'thresh':   (None, None),
        'human_readable':   'Patient has Sleep Apnea?',
    },
    'diabetes_status': {
        'unit':     '',
        'value':    str,
        'thresh':   (None, None),
        'human_readable':   'Diabetes status',
    },
    'home_oxygen': {
        'unit':     '',
        'value':    str,
        'thresh':   (None, None),
        'human_readable':   'Patient on home oxygen?',
    },
    'response_to_medications': {
        'unit':     '',
        'value':    str,
        'thresh':   (None, None),
        'human_readable':   'Response to medications',
    },
    'high_blood_pressure': {
        'unit':     '',
        'value':    str,
        'thresh':   (None, None),
        'human_readable':   'Do you have or are being treated for High Blood Pressure?',
    },
    'influanat': {
        'unit':     '',
        'value':    str,
    ...
    'external_diabetes_eye_exam': {
        ...
        'value':    None,
        'thresh':   (None, None),
        'human_readable':   'External Diabetes Eye Exam',
    },
    'external_hm_diabetes_foot_exam': {
        'unit':     '',
        'value':    None,
        'thresh':   (None, None),
        'human_readable':   'External HM Diabetes Foot Exam',
    },
    'heart_rate_at_rest_without_o2': {
        'unit':     '',
        'value':    None,
        'thresh':   (None, None),
        'human_readable':   'Heart Rate at Rest without O2',
    },
    'sao2_during_exercise_with_o2': {
        'unit':     '',
        'value':    None,
        'thresh':   (None, None),
        'human_readable':   'Sao2 during Exercise with O2',
    },
    'predicted_fev1': {
        'unit':     'L',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'Predicted FEV1 (L)',
    },
    'fev1_ratio': {
        'unit':     '%',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'FEV1 Ratio',
    },
    'mvv': {
        'unit':     'L/min',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'MAX VOLUNTARY VENTIL. (MVV)',
    },
    'predicted_vo2': {
        'unit':     'mL/kg/min',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'Predicted VO2',
    },
    'percent_of_predicted_vo2_max': {
        'unit':     '%',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'Percent of predicted VO2 max',
    },
    'dyspnea_index': {
        'unit':     '%',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'Dyspnea index',
    },
    'end_systolic': {
        'unit':     'mL',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'End systolic (mL)',
    },
    'end_diastolic': {
        'unit':     'mL',
        'value':    float,
        'thresh':   (None, None),
        'human_readable':   'End diastolic (mL)',
    },
    'hm_diabetes_eye_exam': {
        'unit':     '',
        'value':    str,
        'thresh':   (None, None),
        'human_readable':   'HM DIABETES EYE EXAM',
    },
    'hm_diabetes_foot_exam': {
        'unit':     '',
        'value':    str,
        'thresh':   (None, None),
        'human_readable':   'HM DIABETES FOOT EXAM',
    },
    'a1c': {
        'unit':     '',
        'value':    float,
