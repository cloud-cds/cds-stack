...
async def acute_pancreatitis_update(fid, fid_input, conn, log, dataset_id=None, twf_table='cdm_twf'):
    """
    ...
    await clean_tbl.cdm_twf_clean(conn, fid, value = 0,  twf_table='cdm_twf')
    update_clause = """
