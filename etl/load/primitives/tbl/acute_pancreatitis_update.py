def acute_pancreatitis_update(fid, fid_input, cdm, twf_table='cdm_twf'):
    """
    ...
    cdm.clean_twf(fid, value = 0,  twf_table='cdm_twf')
    update_clause = """
    ...
    ;
    """ % { 'twf_table':'cdm_twf'}
    cdm.log.info("acute_pancreatitis_update:%s" % update_clause)
