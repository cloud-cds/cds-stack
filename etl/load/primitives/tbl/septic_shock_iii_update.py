def septic_shock_iii_update(fid, fid_input, cdm,  twf_table='cdm_twf'):
    # UPDATE 8/19/2016
    ...
    cdm.log.info("septic_shock_iii_update step one:%s" % update_clause)
    ...
    cdm.log.info("septic_shock_iii_update step two:%s" % update_clause)
    cdm.update_twf_sql(update_clause)
