...
async def septic_shock_iii_update(fid, fid_input, conn, log, dataset_id, derive_feature_addr, cdm_feature_dict):
  # UPDATE 8/19/2016
  ...
  twf_table_join = get_select_table_joins(fid_input_items, derive_feature_addr, cdm_feature_dict, dataset_id)
  update_clause = """
