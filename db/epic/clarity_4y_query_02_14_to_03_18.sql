...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    AND HOSP_ADMSN_TIME >= '2014-02-01' AND HOSP_ADMSN_TIME < '2015-03-01'
...
USE Analytics;
:OUT \\Client\F$\clarity\vent_info.201402.rpt
SET NOCOUNT ON
...
:OUT \\Client\F$\clarity\adt.201402.rpt
SET NOCOUNT ON
...
:OUT \\Client\F$\clarity\demo.201402.rpt
SET NOCOUNT ON
...
:OUT \\Client\F$\clarity\diag.201402.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201402.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
...
:OUT \\Client\F$\clarity\flt_new.201402.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201402.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201402.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201402.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\lda.201402.rpt
SET NOCOUNT ON
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201402.rpt
SET NOCOUNT ON
SELECT
...
:OUT \\Client\F$\clarity\hist.201402.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201402.rpt
SET NOCOUNT ON
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201402.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,coalesce (lower(med.display_name), lower(med.description))
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201402.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201402.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201402.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,inst.INSTNTD_ORDER_ID
...
:OUT \\Client\F$\clarity\prob.201402.rpt
SET NOCOUNT ON
...
:OUT \\Client\F$\clarity\ed_events.201402.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,ein.EVENT_ID
  ,LINE
...
:OUT \\Client\F$\clarity\final_dx.201402.rpt
SET NOCOUNT ON
select
  CSN.EXTERNAL_ID CSN_ID
  ,dx.line
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2015-03-01' AND HOSP_ADMSN_TIME < '2016-04-01'
) A (csn, pat_id, pat_mrn_id);
...
USE Analytics;
:OUT \\Client\F$\clarity\vent_info.201503.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,inst.INSTNTD_ORDER_ID
...
:OUT \\Client\F$\clarity\adt.201503.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201503.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201503.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201503.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201503.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,coalesce (lower(med.display_name), lower(med.description))
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,coalesce (lower(med.display_name), lower(med.description))
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201503.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201503.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201503.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,inst.INSTNTD_ORDER_ID
...
:OUT \\Client\F$\clarity\prob.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\ed_events.201503.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,ein.EVENT_ID
  ,LINE
...
:OUT \\Client\F$\clarity\final_dx.201503.rpt
SET NOCOUNT ON
select
  CSN.EXTERNAL_ID CSN_ID
  ,dx.line
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-04-01' AND HOSP_ADMSN_TIME < '2017-04-01'
) A (csn, pat_id, pat_mrn_id);
...
USE Analytics;
:OUT \\Client\F$\clarity\vent_info.201604.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,inst.INSTNTD_ORDER_ID
...
:OUT \\Client\F$\clarity\ed_events.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,ein.EVENT_ID
  ,LINE
...
:OUT \\Client\F$\clarity\final_dx.201604.rpt
SET NOCOUNT ON
select
  CSN.EXTERNAL_ID CSN_ID
  ,dx.line
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2017-04-01' AND HOSP_ADMSN_TIME < '2018-04-01'
) A (csn, pat_id, pat_mrn_id);
...
USE Analytics;
:OUT \\Client\F$\clarity\vent_info.201704.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,inst.INSTNTD_ORDER_ID
...
:OUT \\Client\F$\clarity\ed_events.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,ein.EVENT_ID
  ,LINE
...
:OUT \\Client\F$\clarity\final_dx.201704.rpt
SET NOCOUNT ON
select
  CSN.EXTERNAL_ID CSN_ID
  ,dx.line
