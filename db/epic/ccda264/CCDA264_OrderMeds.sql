...
LEFT JOIN Analytics.[WIN\mtoerpe1].CCDA264_MedicationIDs indivMeds ON indivMeds.MedId = med.MEDICATION_ID
...
INNER JOIN 
[WIN\mtoerpe1].CCDA264_CSNLookupTable pat_enc_hsp_1 ON pat_enc_hsp_1.pat_enc_csn_id = med.PAT_ENC_CSN_ID
WHERE (
