...
INNER JOIN Analytics.[WIN\MTOERPE1].CCDA276_CSNLookupTable csn ON PAT_ENC_HSP_1.PAT_ENC_CSN_ID = csn.PAT_ENC_CSN_ID
INNER JOIN Analytics.[WIN\mtoerpe1].CCDA276_PatLookupTable pat ON pat.pat_id = pat_enc_hsp_1.pat_id
