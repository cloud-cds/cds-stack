...
LEFT OUTER JOIN CCDA276_CSNLookupTable csn ON MedicalHistory.MINCSN = csn.PAT_ENC_CSN_ID
INNER JOIN CCDA276_PatLookupTable pat ON pat.PAT_ID = MedicalHistory.PAT_ID
