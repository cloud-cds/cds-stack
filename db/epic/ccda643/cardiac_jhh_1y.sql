...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    AND HOSP_ADMSN_TIME >= '2016-03-01' AND HOSP_ADMSN_TIME < '2016-04-01'
...
:OUT \\Client\F$\clarity\adt.201603.rpt
SET NOCOUNT ON
...
:OUT \\Client\F$\clarity\demo.201603.rpt
SET NOCOUNT ON
...
:OUT \\Client\F$\clarity\diag.201603.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201603.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
...
:OUT \\Client\F$\clarity\flt_new.201603.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201603.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201603.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201603.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\lda.201603.rpt
SET NOCOUNT ON
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201603.rpt
SET NOCOUNT ON
SELECT
...
:OUT \\Client\F$\clarity\hist.201603.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201603.rpt
SET NOCOUNT ON
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201603.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201603.rpt
SET NOCOUNT ON
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201603.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201603.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201603.rpt
SET NOCOUNT ON
...
:OUT \\Client\F$\clarity\order_narrative.201603.rpt
select
...
:OUT \\Client\F$\clarity\surgery_info.201603.rpt
SELECT
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-04-01' AND HOSP_ADMSN_TIME < '2016-05-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201604.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201604.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201604.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201604.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201604.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201604.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201604.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201604.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201604.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201604.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201604.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-05-01' AND HOSP_ADMSN_TIME < '2016-06-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201605.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201605.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201605.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201605.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201605.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201605.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201605.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201605.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201605.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201605.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201605.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-06-01' AND HOSP_ADMSN_TIME < '2016-07-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201606.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201606.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201606.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201606.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201606.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201606.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201606.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201606.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201606.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201606.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201606.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-07-01' AND HOSP_ADMSN_TIME < '2016-08-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201607.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201607.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201607.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201607.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201607.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201607.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201607.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201607.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201607.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201607.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201607.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-08-01' AND HOSP_ADMSN_TIME < '2016-09-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201608.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201608.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201608.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201608.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201608.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201608.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201608.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201608.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201608.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201608.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201608.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-09-01' AND HOSP_ADMSN_TIME < '2016-10-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201609.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201609.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201609.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201609.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201609.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201609.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201609.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201609.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201609.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201609.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201609.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-10-01' AND HOSP_ADMSN_TIME < '2016-11-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201610.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201610.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201610.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201610.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201610.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201610.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201610.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201610.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201610.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201610.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201610.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-11-01' AND HOSP_ADMSN_TIME < '2016-12-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201611.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201611.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201611.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201611.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201611.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201611.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201611.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201611.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201611.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201611.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201611.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2016-12-01' AND HOSP_ADMSN_TIME < '2017-01-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201612.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201612.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201612.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201612.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201612.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201612.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201612.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201612.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201612.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201612.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201612.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2017-01-01' AND HOSP_ADMSN_TIME < '2017-02-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201701.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201701.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201701.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201701.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201701.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201701.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201701.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201701.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201701.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201701.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201701.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2017-02-01' AND HOSP_ADMSN_TIME < '2017-03-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201702.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201702.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201702.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201702.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201702.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201702.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201702.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201702.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201702.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201702.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201702.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2017-03-01' AND HOSP_ADMSN_TIME < '2017-04-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201703.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201703.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201703.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201703.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201703.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201703.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201703.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201703.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201703.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201703.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201703.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2017-04-01' AND HOSP_ADMSN_TIME < '2017-05-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201704.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201704.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201704.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201704.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201704.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201704.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201704.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201704.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201704.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201704.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201704.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2017-05-01' AND HOSP_ADMSN_TIME < '2017-06-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201705.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201705.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201705.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201705.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201705.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201705.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201705.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201705.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201705.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201705.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201705.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
...
(SELECT DISTINCT pat_enc_hsp_1.PAT_ENC_CSN_ID, patient.PAT_ID, patient.PAT_MRN_ID
  ...
  -- ENSURE PATIENT WAS ADMITTED TO ONE OF THE HOWARD COUNTY UNITS YOU ARE STUDYING
    ...
    HOSP_DISCH_TIME IS NOT NULL
    --admitted between the dates in your cohort
    AND HOSP_ADMSN_TIME >= '2017-06-01' AND HOSP_ADMSN_TIME < '2017-07-01'
) A (csn, pat_id, pat_mrn_id);
...
:OUT \\Client\F$\clarity\adt.201706.rpt
SET NOCOUNT ON
SELECT CSN.EXTERNAL_ID CSN_ID
  ,CASE
    WHEN EVENT_TYPE_C = 1
...
:OUT \\Client\F$\clarity\demo.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID pat_id
  ,ADT_ARRIVAL_TIME
...
:OUT \\Client\F$\clarity\diag.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT CSN.EXTERNAL_ID CSN_ID
  ,edg.DX_ID
  ,DX_ED_YN
...
:OUT \\Client\F$\clarity\flt_lda.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt_new.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\flt.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT  csn.EXTERNAL_ID CSN_ID
  ,IP_FLO_GP_DATA.FLO_MEAS_NAME
  ,IP_FLO_GP_DATA.DISP_NAME
...
:OUT \\Client\F$\clarity\labs.201706.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
:OUT \\Client\F$\clarity\labs_new.201706.rpt
SET NOCOUNT ON
SELECT csn.EXTERNAL_ID CSN_ID
  ,COMP.COMPONENT_ID
  ,COMP.BASE_NAME
...
/****** Script for SelectTopNRows command from SSMS  ******/
:OUT \\Client\F$\clarity\lda.201706.rpt
SET NOCOUNT ON
SELECT pat.EXTERNAL_ID PAT_ID
      ,[PLACEMENT_INSTANT]
     ,GP.FLO_MEAS_NAME
...
USE CLARITY;
:OUT \\Client\F$\clarity\mar.201706.rpt
SET NOCOUNT ON
SELECT
  csn.EXTERNAL_ID CSN_ID,
  med.display_name, medindex.MEDICATION_ID, medindex.Thera_Class_c, medindex.pharm_class_c
...
:OUT \\Client\F$\clarity\hist.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT csn.EXTERNAL_ID CSN_ID
  ,pat.EXTERNAL_ID PATIENTID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\ordermed_home.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,med.display_name
  ,med.ORDER_INST
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc.201706.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.PROC_ID OrderProcId
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_img.201706.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.ORDER_PROC_ID
  ,procs.display_name
...
USE Analytics;
:OUT \\Client\F$\clarity\orderproc_new.201706.rpt
SET NOCOUNT ON
SELECT PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID
  ,procs.proc_id OrderProcId
  ,procs.display_name
...
:OUT \\Client\F$\clarity\prob.201706.rpt
SET NOCOUNT ON
SELECT DISTINCT pat.EXTERNAL_ID PAT_ID
  ,CSN.EXTERNAL_ID CSN_ID
  ,CAST(COALESCE(Encounter.DEPARTMENT_ID, HospitalEncounter.DEPARTMENT_ID) AS VARCHAR(50)) DEPARTMENTID
...
:OUT \\Client\F$\clarity\order_narrative.201706.rpt
select
	PAT_ENC_HSP_1.EXTERNAL_ID CSN_ID,
	op.PROC_ID OrderProcId, -- selected to be the same as OrderProcs, though this may create confusion.
	op.display_name order_display_name,
...
:OUT \\Client\F$\clarity\surgery_info.201706.rpt
SELECT
  coalesce(hsp.PAT_ENC_CSN_ID, patadmlink.OR_LINK_CSN) as csn_id,
  orcase.OR_CASE_ID,
  orlog.LOG_ID,
