...
-- select dataset_id, enc_id, note_id, note_type, note_status, start_ts,
...
--           as note_body3
-- from (
-- select  N.dataset_id, N.enc_id, N.note_id, N.note_type, N.note_status,
...
-- from (
--   select N.dataset_id, N.enc_id, N.note_id, N.note_type, N.note_status, N.dates,
