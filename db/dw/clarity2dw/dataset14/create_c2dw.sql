...
VALUES (14,
        now(),
        'hcgh 1 month starting from 2017-07-22')
...
select 14, func_id,func_type, description from cdm_function_temp
...
select 14, fid, category, data_type, is_measured, is_deprecated,
                         fillin_func_id, window_size_in_hours, derive_func_id,
                         derive_func_input, description, version, unit
...
insert into parameters (dataset_id, name, value)
  select 14, name, value from parameters_temp
...
insert into criteria_default (dataset_id, name, fid, override_value, category)
  select 14, name, fid, override_value, category from criteria_default_temp
