...
septic_shock = {
    ...
    "is_met": False,
    "onset_time": None,
    "fluid_administered": False,
    "fluid_administered_time": None,
...
patient_data_example = {
    ...
    init_lactate['name']: init_lactate,
    blood_culture['name']: blood_culture,
    antibiotics['name']: antibiotics,
    fluid['name']: fluid,
    repeat_lactate['name']: repeat_lactate,
    vasopressors['name']: vasopressors,
    'chart_data': {
        'chart_values': {
