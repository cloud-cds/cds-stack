...
LEFT OUTER JOIN CCDA276_CSNLookupTable csn ON FirstHistory.HX_PROBLEM_EPT_CSN = csn.PAT_ENC_CSN_ID
INNER JOIN CCDA276_PatLookupTable pat ON pat.PAT_ID = ProblemList.PAT_ID
