...
\copy "Labs" from '/udata/zad/hc_epic_16/labs.rpt' with NULL 'NULL' csv header delimiter as E'\t';
...
\copy "Labs_643" from '/udata/zad/hc_epic_16/labs_new.rpt' with NULL 'NULL' csv header delimiter as E'\t';
...
\copy "LDAs" from '/udata/zad/hc_epic_16/lda.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "MedicationAdministration" from '/udata/zad/hc_epic_16/mar.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "MedicalHistory" from '/udata/zad/hc_epic_16/hist.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "Notes" from '/udata/zad/hc_epic_16/note.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderMed" from '/udata/zad/hc_epic_16/ordermed.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderMedHome" from '/udata/zad/hc_epic_16/ordermed_home.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderProcs" from '/udata/zad/hc_epic_16/orderproc.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderProcsImage" from '/udata/zad/hc_epic_16/orderproc_img.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderProcs_643" from '/udata/zad/hc_epic_16/orderproc_new.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "ProblemList" from '/udata/zad/hc_epic_16/prob.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes