...
\copy "Demographics" from '~/Downloads/clarity/demo.rpt' with csv header delimiter as E'\t' NULL 'NULL';
...
\copy "ADT_Feed" from '~/Downloads/clarity/adt.rpt' with csv header delimiter as E'\t' NULL 'NULL';
...
\copy "Diagnoses" from '~/Downloads/clarity/diag.rpt' with csv header delimiter as E'\t' NULL 'NULL';
...
\copy "FlowsheetValue-LDA" from '~/Downloads/clarity/flt_lda.rpt' with csv header delimiter as E'\t' NULL 'NULL';
...
\copy "FlowsheetValue" from '~/Downloads/clarity/flt.rpt' with csv header delimiter as E'\t' NULL 'NULL';
...
\copy "FlowsheetValue_643" from '~/Downloads/clarity/flt_new.rpt' with csv header delimiter as E'\t' NULL 'NULL';
...
\copy "Labs" from '~/Downloads/clarity/labs.rpt' with NULL 'NULL' csv header delimiter as E'\t';
...
\copy "Labs" from '~/Downloads/clarity/labs_new.rpt' with NULL 'NULL' csv header delimiter as E'\t';
...
\copy "LDAs" from '~/Downloads/clarity/lda.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "MedicationAdministration" from '~/Downloads/clarity/mar.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "MedicalHistory" from '~/Downloads/clarity/hist.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "Notes" from '~/Downloads/clarity/note.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderMed" from '~/Downloads/clarity/ordermed.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderMedHome" from '~/Downloads/clarity/ordermed_home.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderProcs" from '~/Downloads/clarity/orderproc.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderProcsImage" from '~/Downloads/clarity/orderproc_img.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "OrderProcs_643" from '~/Downloads/clarity/orderproc_new.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes
...
\copy "ProblemList" from '~/Downloads/clarity/prob.rpt' with NULL 'NULL' csv header delimiter as E'\t' QUOTE E'\b'; -- a ugly but working solution to ignore quotes