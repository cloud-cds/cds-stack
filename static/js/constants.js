...
var ALERT_CODES = {
	...
	"301": "intervention(s) need to be ordered", 										// Should be prefixed with count of number of severe sepsis interventions pending.
	"302": "intervention(s) need to be ordered", 										// Should be prefixed with count of number of septic shock interventions pending.
	"303": "intervention(s) need to be completed in the next hour", // Should be prefixed with the number of severe sepsis interventions to be completed before the 3hr window expires.
	"304": "intervention(s) need to be completed in the next hour", // Should be prefixed with the number of severe sepsis interventions to be completed before the 6hr window expires.
	"305": "intervention(s) need to be completed in the next hour"  // Should be prefixed with the number of septic shock interventions to be completed before the 6hr window expires.
}
