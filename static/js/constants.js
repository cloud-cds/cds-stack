...
var ALERT_CODES = {
	...
	"302": "intervention(s) need to be ordered", // Should be prefixed with count of number of interventions pending.
	"303": "intervention(s) need to be completed in the next hour" // Should be prefixed with the number of interventions to be completed.
}
