...
select 11, func_id,func_type, description from cdm_function_temp
...
select 11, fid, category, data_type, is_measured, is_deprecated,
                         fillin_func_id, window_size_in_hours, derive_func_id,
                         derive_func_input, description, version, unit
...
delete from criteria_default where dataset_id = 11;
insert into criteria_default
  select 11, name, fid, override_value, category
