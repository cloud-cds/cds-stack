...
resource "aws_lambda_function" "trews_labeler_lambda" {
    ...
    function_name    = "${var.deploy_prefix}_dev_trews_labeler_lambda"
    ...
    environment {
      variables {
        ...
        kube_job_name   = "trews-labeler-dev"
...
resource "aws_cloudwatch_event_rule" "trews_labeler_lambda_schedule_rule" {
    name = "${var.deploy_prefix}_dev_trews_labeler_schedule_rule"
...
resource "aws_cloudwatch_event_target" "trews_labeler_lambda_schedule_rule_target" {
    ...
    target_id = "${var.deploy_prefix}_dev_trews_labeler_lambda"
